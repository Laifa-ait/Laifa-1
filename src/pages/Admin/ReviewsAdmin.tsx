  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
          <h2 className="text-3xl font-black tracking-tight rtl:tracking-normal text-zinc-950 uppercase">{t("Modération des Avis")}</h2>
      ...
      <div className="bg-white rounded-[2rem] border border-zinc-100 shadow-sm overflow-hidden p-12 text-center text-zinc-500">
         ...
         <h3 className="text-lg font-black text-zinc-900 mb-2">{t("Aucun avis à modérer")}</h3>
