  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
          <h2 className="text-3xl font-kinder tracking-tight rtl:tracking-normal text-zinc-950 uppercase">{t("Notifications Push")}</h2>
      ...
      <div className="grid md:grid-cols-2 gap-8">
        <div className="bg-white p-8 rounded-[2rem] border border-zinc-100 shadow-sm space-y-6">
          <div className="space-y-2">
             <label className="text-xs font-kinder uppercase tracking-widest rtl:tracking-normal text-zinc-500">{t("Titre de la notification")}</label>
          ...
          <div className="space-y-2">
             <label className="text-xs font-kinder uppercase tracking-widest rtl:tracking-normal text-zinc-500">{t("Message")}</label>
          ...
          <button onClick={sendNotification} disabled={!title || !message} className="w-full py-4 bg-indigo-600 text-white rounded-xl font-kinder uppercase tracking-widest rtl:tracking-normal text-xs flex items-center justify-center gap-2 hover:bg-indigo-700 disabled:opacity-50 transition-colors">
        ...
        <div className="bg-orange-50 p-8 rounded-[2rem] border border-orange-100 shadow-sm flex flex-col justify-center items-center text-center">
           ...
           <h3 className="text-2xl font-kinder tracking-tight rtl:tracking-normal mb-2 uppercase text-zinc-950">{t("Engagement en temps réel")}</h3>
