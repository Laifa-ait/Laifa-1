...
export const PremiumCollection: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#FAF8F5]" ref={containerRef}>
                ...
                <div className="relative ms-auto shrink-0 z-[100]">
                  ...
                  {showSortDropdown && (
                    <>
                      ...
                      <div className="absolute right-0 top-full mt-1.5 bg-white border border-[#121315]/10 rounded-xl shadow-xl z-50 py-1.5 min-w-[150px] animate-in fade-in-50 slide-in-from-top-1 rtl:left-0 rtl:right-auto">
                        {[
        ...
        {showAdvancedFilters && (
          <>
            ...
            <motion.div
              ...
              className="fixed inset-y-0 right-0 w-full max-w-md bg-[#FAF6EE] shadow-2xl z-[201] flex flex-col overflow-hidden text-[#121315]"
            >
              {/* Header */}
              ...
              <div className="flex-1 overflow-y-auto p-6 space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <ChevronDown className="absolute right-4 top-1/2 -translate-y-1/2 w-4 h-4 text-[#121315] pointer-events-none" />
                  </div>
                </div>
                    ...
                    {[
                      ...
                      return (
                        ...
                        >
                          ...
                          <div>
                            <div className={`text-[10px] font-black uppercase tracking-widest rtl:tracking-normal ${isActive ? "text-[#F37021]" : "text-[#121315]"}`}>{opt.name}</div>
                            <div className="text-[9px] text-[#121315]/60 mt-0.5 leading-relaxed font-semibold">{opt.desc}</div>
                          </div>
                        </button>
                      );
                    })}
