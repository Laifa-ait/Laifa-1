...
export const ProductFilterPage: React.FC = () => {
  ...
  return (
    <div className="bg-[#FAF8F5] min-h-screen pb-20">
      ...
      <div className="relative border-b border-[#EBE5DF]/40 bg-[#FAF8F5] text-[#121315] py-16 px-6 overflow-hidden">
        <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-[#F37021]/5 rounded-full blur-[100px] -mr-48 -mt-48 opacity-30" />
        
        <div className="max-w-[1850px] mx-auto relative z-10">
          <button
            onClick={() => navigate(-1)}
            className="inline-flex items-center gap-2 text-xs font-black uppercase tracking-widest rtl:tracking-normal text-[#121315]/60 hover:text-[#F37021] transition-colors mb-6 cursor-pointer"
          >
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div className="space-y-3">
              <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-[#121315]/5 border border-[#121315]/10 text-[9px] uppercase font-black tracking-widest rtl:tracking-normal text-[#F37021]">
                <Tag className="w-3.5 h-3.5 fill-current" />
                {t("Collection Sélectionnée")}</span>
              <h1 className="text-4xl sm:text-5xl md:text-6xl font-black tracking-tight rtl:tracking-normal uppercase text-[#121315]">
      ...
      <div className="max-w-[1850px] mx-auto px-6 py-12">
        {isLoading ? (
          <div className="flex flex-col items-center justify-center p-24 space-y-4">
            ...
            <span className="text-xs font-black text-zinc-500 uppercase tracking-widest rtl:tracking-normal">{t("Hydratation des produits sous le tag...")}</span>
          </div>
        ) : products.length === 0 ? (
          <div className="p-16 text-center bg-white rounded-[2rem] border border-zinc-100 shadow-sm space-y-4 max-w-lg mx-auto">
            ...
            <h3 className="text-base font-black text-zinc-700 uppercase">{t("Aucun produit pour l'instant")}</h3>
            ...
            <button
              ...
              className="mt-4 px-6 py-3 bg-zinc-950 text-white rounded-xl font-black text-[10px] uppercase tracking-widest rtl:tracking-normal hover:bg-orange-600 hover:text-white transition-colors cursor-pointer shadow-md select-none"
            >
