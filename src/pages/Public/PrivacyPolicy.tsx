    ...
    useEffect(() => {
        const fetchPolicy = async () => {
            try {
                ...
                if (docSnap.exists() && docSnap.data().privacyPolicy) {
                    setPolicyText(docSnap.data().privacyPolicy);
                } else {
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6">
                <div className="bg-white rounded-3xl p-8 sm:p-12 shadow-sm border border-stone-100">
                    <div className="flex items-center gap-4 mb-8 pb-8 border-b border-stone-100">
                        ...
                        <div>
                            <h1 className="text-2xl sm:text-3xl font-kinder text-stone-900 tracking-tight">{t("Politique de Confidentialité")}</h1>
