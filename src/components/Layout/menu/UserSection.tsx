      ...
      {currentUser ? (
        <div className="relative z-10 flex items-center gap-4">
          <button
            ...
            className="w-16 h-16 rounded-2xl border-4 border-white/10 overflow-hidden shadow-lg cursor-pointer hover:border-white/30 transition-colors"
          >
            <img
              loading="lazy"
              src={
                userProfile?.photoURL || currentUser.photoURL || getRetroAvatar(currentUser.email || currentUser.uid)
              }
