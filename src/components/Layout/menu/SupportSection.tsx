    ...
    <div className="pt-6 border-t border-slate-200/60 pb-4">
      <div className="space-y-2">
        <button
          ...
          className="w-full flex items-center gap-4 px-5 py-4 bg-white border border-slate-200/60 rounded-2xl text-[#3C2B22]/70 hover:text-[#ea580c] hover:border-orange-200 hover:shadow-sm hover:-translate-y-0.5 transition-all duration-300 ease-out font-bold text-sm cursor-pointer shadow-sm"
        >
          <Globe className="w-5 h-5 text-[#3C2B22]/50" />
        ...
        <button
          ...
          className="w-full flex items-center gap-4 px-5 py-4 bg-white border border-slate-200/60 rounded-2xl text-[#3C2B22]/70 hover:text-[#ea580c] hover:border-orange-200 hover:shadow-sm hover:-translate-y-0.5 transition-all duration-300 ease-out font-bold text-sm cursor-pointer shadow-sm"
        >
          <Info className="w-5 h-5 text-[#3C2B22]/50" />
          {t("À propos d'Olma")}
        </button>
        {currentUser && (
          <button
      ...
      >
        <div className="flex items-center gap-3">
          <Truck className="w-5 h-5 text-[#FF5C00]" />
          <div className="flex flex-col">
            <span className="text-xs rtl:text-sm font-kinder text-[#3C2B22] uppercase tracking-tight rtl:tracking-normal">
              {t("Estimer mes frais de port")}
            </span>
            <span className="text-[10px] rtl:text-[12px] font-bold text-zinc-450">
              {t("Frais et livraison 58 Wilayas")}
            </span>
          </div>
        </div>
