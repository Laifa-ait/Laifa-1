        ...
        <>
          ...
          >
            ...
            <div className="px-6 py-4 border-b border-slate-100 flex items-center justify-between bg-slate-50 shrink-0">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="p-2 text-slate-400 hover:text-slate-900 hover:bg-slate-100 rounded-xl transition-all cursor-pointer border-none bg-transparent"
                >
            ...
            <div className="flex-1 overflow-y-auto px-6 py-6 space-y-8 custom-scrollbar">
              ...
              <div className="p-4 bg-slate-50 rounded-2xl border border-slate-100 text-[11px] font-bold text-slate-700 space-y-1">
