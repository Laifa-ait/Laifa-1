            ...
            <div className="bg-white px-6 py-5 border-b border-zinc-100 flex items-center justify-between shadow-sm z-10 shrink-0">
               <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs rtl:text-sm font-bold text-stone-400 uppercase tracking-wider rtl:tracking-normal">{t("Discussion relative à la commande #")}{orderId.substring(0,8)}</p>
                  </div>
               </div>
               <button 
                  onClick={onClose}
