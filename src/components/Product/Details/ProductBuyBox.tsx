...
export const ProductBuyBox: React.FC<BuyBoxProps> = ({
  product, isCurrentSelectionOutOfStock, onAddToCart, onToggleWishlist,
  wishlist, onShare, stickyRef, isSticky
}) => {
  const { t } = useTranslation();

  return (
    <div ref={stickyRef} className={`z-40 ${isSticky ? "fixed bottom-0 left-0 right-0 p-4 sm:p-6 bg-white/90 backdrop-blur-xl shadow-[0_-10px_40px_rgba(30,67,86,0.08)] border-t border-stone-200/50 animate-in slide-in-from-bottom-12 duration-300" : "relative"}`}>
