          ...
          <div className="space-y-6">
            <div className="flex items-start gap-4 p-4 bg-blue-50 rounded-2xl border border-blue-100">
              ...
              <div>
                ...
                <p className="text-blue-600 text-[11px] font-bold mt-0.5">
                  {t("Plus que")}
                  <span className="text-base">{Math.max(SALES_THRESHOLD - currentSales, 0)}</span>{" "}
                  {t("ventes pour apparaître sur la page d'accueil !")}
                </p>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <p className="text-[10px] rtl:text-[12px] text-zinc-500 font-medium text-center">
                {t(
                  'Les "Incontournables" sont sélectionnés chaque jour à 3h00 parmi les produits dépassant le seuil de vente.'
                )}
              </p>
            </div>
          </div>
