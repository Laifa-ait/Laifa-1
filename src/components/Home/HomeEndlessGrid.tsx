...
export const HomeEndlessGrid: React.FC = () => {
  ...
  return (
    <div className="w-full max-w-[90rem] mx-auto px-4 sm:px-6 md:px-8 pb-16 pt-16 bg-slate-50">
      <div className="flex flex-col items-center justify-center text-center mb-10">
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-sky-50 text-sky-600 font-sans text-[10px] font-bold uppercase tracking-widest mb-4">
          <Sparkles className="w-4 h-4" />
          {t("home.endless_grid.badge") || "COLLECTION INFINIE"}
        </div>
        <h3 className="font-display text-3xl md:text-4xl lg:text-5xl font-semibold tracking-tight text-slate-900 uppercase">
          {t("home.endless_grid.title") || "Galerie d'Inspirations"}
        </h3>
        <p className="font-sans text-sm md:text-base text-slate-500 uppercase tracking-wider max-w-2xl leading-relaxed mt-4">
