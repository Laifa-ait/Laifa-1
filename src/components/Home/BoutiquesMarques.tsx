...
const FALLBACK_SELLERS = [
  { id: "maison-kabyle", shopName: "Maison Kabyle", wilaya: "15 Tizi Ouzou - Algérie", logoUrl: "https://ui-avatars.com/api/?name=Maison+Kabyle&background=1E4356&color=fff&size=80&bold=true", bannerUrl: "https://images.unsplash.com/photo-1490481651871-ab68de25d43d?auto=format&fit=crop&q=80&w=800" },
  { id: "art-biskra", shopName: "Art de Biskra", wilaya: "07 Biskra - Algérie", logoUrl: "https://ui-avatars.com/api/?name=Art+de+Biskra&background=1E4356&color=fff&size=80&bold=true", bannerUrl: "https://images.unsplash.com/photo-1513519245088-0e12902e5a38?auto=format&fit=crop&q=80&w=800" },
  { id: "cuir-algerois", shopName: "Cuir Algérois", wilaya: "16 Alger - Algérie", logoUrl: "https://ui-avatars.com/api/?name=Cuir+Algerois&background=1E4356&color=fff&size=80&bold=true", bannerUrl: "https://images.unsplash.com/photo-1506157786151-b8491531f063?auto=format&fit=crop&q=80&w=800" },
  { id: "bijoux-touareg", shopName: "Bijoux Touareg", wilaya: "11 Tamanrasset - Algérie", logoUrl: "https://ui-avatars.com/api/?name=Bijoux+Touareg&background=1E4356&color=fff&size=80&bold=true", bannerUrl: "https://images.unsplash.com/photo-1479064555552-3ef4979f8908?auto=format&fit=crop&q=80&w=800" },
  { id: "tapis-ghardaia", shopName: "Tapis Ghardaïa", wilaya: "47 Ghardaïa - Algérie", logoUrl: "https://ui-avatars.com/api/?name=Tapis+Ghardaia&background=1E4356&color=fff&size=80&bold=true", bannerUrl: "https://images.unsplash.com/photo-1441986300917-64674bd600d8?auto=format&fit=crop&q=80&w=800" }
];
...
export const BoutiquesMarques: React.FC<BoutiquesMarquesProps> = ({ sellers, isLoading }) => {
  ...
  const getSellersList = () => {
    ...
    return FALLBACK_SELLERS as unknown as Shop[];
  };
          ...
          >
            {isLoading ? (
              ...
              listToRender.map((seller, index) => {
                const coverImage = getOptimizedImageUrl(seller.bannerUrl, 400) || DEFAULT_COVERS[index % DEFAULT_COVERS.length];
                const avatarImage = getOptimizedImageUrl(seller.logoUrl, 200) || `https://ui-avatars.com/api/?name=${encodeURIComponent(seller.shopName || 'B')}&background=1E4356&color=fff&size=100&bold=true`;
