                      ...
                      <div className="flex items-center gap-1">
                        ...
                        <span>
                          {req.returnRequest?.createdAt
                            ? new Date(req.returnRequest.createdAt).toLocaleDateString()
                            : t("Inconnu")}
                        </span>
                      </div>
                      <div className="flex items-center gap-1">
      ...
      <div className="bg-orange-50 border border-orange-100 rounded-2xl p-5 flex gap-4 mt-6">
        ...
        <div>
          ...
          <p className="text-orange-700/80 text-xs rtl:text-sm font-medium leading-relaxed">
            {t(
              "Notre modèle de Paiement à la Livraison permet de vérifier le colis à réception. Si un article ne correspond pas (taille, modèle), signalez-le immédiatement. Les retours validés sont remboursés sur votre Olma Wallet pour un usage futur."
            )}
          </p>
        </div>
      </div>
