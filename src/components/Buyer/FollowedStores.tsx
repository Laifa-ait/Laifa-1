            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {stores.map((store) => {
                return (
                  <div
                    key={store.id}
                    className="border border-stone-200/60 rounded-2xl p-5 flex gap-4 hover:border-stone-400 hover:shadow-md transition-all bg-white relative group"
                  >
                    <div className="absolute top-4 right-4 text-[10px] rtl:text-[12px] font-bold text-stone-400 font-mono uppercase">
                      {t("VIP")}
                    </div>
