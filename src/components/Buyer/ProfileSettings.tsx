  ...
  return (
    <div className="space-y-8" id="profile-settings-module">
      ...
      <form
        ...
        className="bg-white border border-zinc-100 rounded-3xl p-8 space-y-8 shadow-sm"
      >
        {/* Avatar Selectors */}
        <div className="space-y-4">
          <label className="text-[10px] rtl:text-[12px] font-bold text-stone-500 uppercase tracking-wider rtl:tracking-normal block leading-none">
        ...
        <div className="grid sm:grid-cols-2 gap-6">
          ...
          <div className="space-y-2">
            <label className="text-[10px] rtl:text-[12px] font-bold text-stone-500 uppercase tracking-wider rtl:tracking-normal block leading-none font-sans">
